class ComentariosController < ApplicationController
  ...
  # GET /comentarios/like/1
  # def findByQuantLikes
  #   @comentario = Comentario.find(params[:like])
  ...
  private
    ...
    def comentario_params
      params.require(:comentario).permit(:mensagem, :like, :deslike, 
        comentarios_attributes: [:id, :mensagem, :like, :deslike, :_destroy]
      )
    end
end
